...
export  function Header1() {
    ...
    return (
        <>
            ...
            <a href="/" className="navitem active">홈</a>
            <a href="" className="navitem">견적요청</a>
            <a href="" className="navitem">전문가찾기</a>
            <a href="" className="navitem">공구대여</a>
            <a href="" className="navitem">자재마켓</a>
            <a href="" className="navitem">자재 100</a>
            <a href="" className="navitem">커뮤니티</a>
            </div>
