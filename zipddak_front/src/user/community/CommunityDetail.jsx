...
export default function Comdetail() {
    ...
    const ComContent = {
        ...
        Writer: "닉네임",
        content: "방을 꾸미는데 자꾸 의견이 안맞아서 여기에 조언을 구합니다..!방을 꾸미는데 자꾸 의견이 안맞아서 여기에 조언을 구합니다..!방을 꾸미는데 자꾸 의견이 안맞아서 여기에 조언을 구합니다..!둘중에 더 괜찮은 것 같은 배치를 알려주세요..ㅜ귀찮으시면 1 / 2 이렇게라도..아니면 다른 배치에 대한 조언도 환영입니다~!!!",
        commentCnt : 5,
        viewCnt : 80,
        category:"전문가에게 묻다",
