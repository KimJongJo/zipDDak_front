                    ...
                    <div className="regToolForm">
                        ...
                        <div className="options">
                            ...
                            <div className="check-col">
                                <FormGroup check>
                                    <Input name="radio2" type="radio" /> <Label check>전동공구</Label>
                                </FormGroup>

                                <FormGroup check>
                                    <Input name="radio2" type="radio" /> <Label check>일반공구</Label>
                                </FormGroup>

                                <FormGroup check>
                                    <Input name="radio2" type="radio" /> <Label check>생활용품</Label>
                                </FormGroup>

                                <FormGroup check>
                                    <Input name="radio2" type="radio" /> <Label check>기타공구</Label>
                                </FormGroup>

                                <FormGroup check>
                                    <Input name="radio2" type="radio" /> <Label check>찾아요</Label>
                                </FormGroup>
                            </div>
                        </div>
                        ...
                        <div className="options">
                            ...
                            <div className="check-col">
                                ...
                                <FormGroup check>
                                    <Input id="checkbox2" type="checkbox" /> <Label check>무료대여</Label>
                                </FormGroup>
                            </div>
                        </div>
                        ...
                        <div className="options">
                            ...
                            <div className="check-col">
                                <FormGroup check>
                                    <Input id="checkbox2" type="checkbox" checked /> <Label check>문의후 대여</Label>
                                </FormGroup>
                                <FormGroup check>
                                    <Input id="checkbox2" type="checkbox" /> <Label check>바로대여</Label>
                                </FormGroup>
                        ...
                        <div className="options">
                            ...
                            <div className="check-col">
                                <FormGroup check>
                                    <Input id="checkbox2" type="checkbox" /> <Label check>택배 배송</Label>
                                </FormGroup>
                                <FormGroup check>
                                    <Input id="checkbox2" type="checkbox" /> <Label check>직접 픽업</Label>
                                </FormGroup>
                            </div>
                        </div>
                        ...
                        <div className="options">
                            ...
                            <div className="check-col">
                                ...
                                <FormGroup check>
                                    <Input id="checkbox2" type="checkbox" /> <Label check>무료배송</Label>
                                </FormGroup>
                            </div>
                        </div>
                        ...
                        <div className="options">
                            ...
                            <div className="check-col">
                                <FormGroup check>
                                    <Input name="radio2" type="radio" defaultChecked /> <Label check>대여가능</Label>
                                </FormGroup>
                                <FormGroup check>
                                    <Input name="radio2" type="radio" /> <Label check>대여중지</Label>
                                </FormGroup>
                            </div>
                        </div>
                    </div>
