            ...
            <div className="signStore2">
                ...
                <div className="s_form">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="email" placeholder="이메일 아이디 생성" type="email" />
                                </div>
                                <div>
                                    <Button>인증하기</Button>
                                </div>
                    ...
                    <div className="signStoreForm">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="password" placeholder="비밀번호를 입력" type="password" />
                                </div>

                                <div className="s_input">
                                    <Input name="password" placeholder="비밀번호 확인" type="password" />
                                </div>
                            </div>
                    ...
                    <div className="signStoreForm">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="name" placeholder="이름(실명) 입력" type="text" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="signStoreForm">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="tel" placeholder="‘-’제외 숫자만 입력" type="text" />
                                </div>
                                <div>
                                    <Button>인증하기</Button>
                                </div>
                ...
                <div className="s_form">
                    ...
                    <div className="signStoreForm">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="email" placeholder="숫자만 13자 입력" type="email" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="signStoreForm">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="email" placeholder="*pdf파일 첨부" type="email" />
                                </div>
                                <div>
                                    <Button>첨부하기</Button>
                                </div>
                    ...
                    <div className="signStoreForm">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="email" placeholder="회사이름 입력" type="email" />
                                </div>
                            </div>
                    ...
                    <div className="signStoreForm">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="site" placeholder="https://" type="text" />
                                </div>
                            </div>
                ...
                <div className="s_form">
                    ...
                    <div className="signStoreForm">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="email" placeholder="가입한 이메일 아이디" type="email" />
                                </div>
                                <div>
                                    <Button>인증하기</Button>
                                </div>
                ...
                <div className="s_form">
                    ...
                    <div className="signStoreForm">
                        ...
                        <div className="s_formCol">
                            <div className="s_formRow">
                                <div className="s_input">
                                    <Input name="name" placeholder="상점이름 입력" type="text" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="s_form">
                    ...
                    <div className="s_checkbody">
                        <div className="s_check">
                            <FormGroup check>
                                <Input type="checkbox" /> <Label check>입점신청을 위한 개인정보 수집 및 이용에 동의 [필수]</Label>
                            </FormGroup>
                        </div>
                    </div>
                </div>
