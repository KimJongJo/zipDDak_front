...
export default function Message() {
  ...
  useEffect(() => {
    ...
    const updatedRoom = chatList.find(
      (room) => room.messageRoomIdx === selectMessageRoomIdx
    );
                      ...
                      <div className="message-bubble-recive-hasButton-wrapper">
                        <div>
                          ...
                          <button
                            ...
                            onClick={() =>
                              navigate(
                                `/zipddak/expertMatchPayment/${selectedRoom.estimateIdx}`
                              )
                            }
                          >
                            결제하기
