      ...
      <div>
        ...
        <div className="labelInput-wrapper">
          ...
          <p style={{ fontWeight: "600" }}>
            {Number(orderDetail.totalProductPrice).toLocaleString()}원
          </p>
        </div>
        <div className="labelInput-wrapper">
        ...
        <div className="labelInput-wrapper">
          ...
          <p style={{ fontWeight: "600", color: "#FF5833" }}>
            {Number(orderDetail.totalPaymentPrice).toLocaleString()}원
          </p>
        </div>
        <div className="labelInput-wrapper">
      ...
      {orderDetail.CancelInfo && (
        <div>
          ...
          <div className="labelInput-wrapper">
            ...
            <p style={{ fontWeight: "600", color: "#FF5833" }}>
              {Number(orderDetail.CancelInfo?.cancelAmount).toLocaleString()}원
            </p>
          </div>
          <div className="labelInput-wrapper">
      ...
      {orderDetail.RefundInfo && (
        <div>
          ...
          <div className="labelInput-wrapper">
            ...
            <p>
              {Number(
                orderDetail.RefundInfo?.returnShippingFee
              ).toLocaleString()}
              원
            </p>
          </div>
          <div className="labelInput-wrapper">
            <label style={{ width: "150px" }}>환불금액</label>
            <p style={{ fontWeight: "600", color: "#FF5833" }}>
              {Number(orderDetail.RefundInfo?.refundAmount).toLocaleString()}원
            </p>
          </div>
          <div className="labelInput-wrapper">
      ...
      {orderDetail.ExchangeInfo && (
        <div>
            ...
            >
              <div className="mypage-radio">
                <input
                  ...
                  name="shippingPayer"
                  checked={
                    orderDetail.ExchangeInfo?.shippingChargeType === "SELLER"
                  }
                  disabled
                />
              ...
              <div className="mypage-radio">
                <input
                  ...
                  name="shippingPayer"
                  checked={
                    orderDetail.ExchangeInfo?.shippingChargeType === "BUYER"
                  }
                  disabled
                />
          ...
          <div className="labelInput-wrapper">
            ...
            <p style={{ fontWeight: "600" }}>
              {Number(
                orderDetail.ExchangeInfo?.roundShippingFee
              ).toLocaleString()}
              원
            </p>
          </div>
      ...
      >
        ...
        <div style={{ flex: 2 }}>
          ...
          <div className="labelInput-wrapper">
            ...
            <p>
              {orderDetail.postCode} {orderDetail.address1}{" "}
      ...
      {orderDetail.ExchangeInfo && (
        <div>
          ...
          <div className="labelInput-wrapper">
            <label style={{ width: "150px" }}>주소</label>
            <p>
              {orderDetail.ExchangeInfo?.reshipZipcode}{" "}
              {orderDetail.ExchangeInfo?.reshipAddr1}{" "}
              {orderDetail.ExchangeInfo?.reshipAddr2}
            </p>
          </div>
          <div className="labelInput-wrapper">
            <label style={{ width: "150px" }}>배송요청사항</label>
        ...
        <button
          ...
          onClick={() => {
            type == "order"
              ...
              : navigate("/zipddak/mypage/market/returns");
          }}
        >
          목록
        </button>
